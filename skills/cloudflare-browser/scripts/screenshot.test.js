...
describe('screenshot.js', () => {
  ...
  it('handles FTP URLs gracefully', async () => {
    const result = await runScript(['ftp://ftp.example.com/file'], {
      CDP_SECRET: 'test-secret',
      WORKER_URL: 'wss://invalid.test',
    });
  ...
  it('handles file:// URLs', async () => {
    const result = await runScript(['file:///tmp/test.html'], {
      CDP_SECRET: 'test-secret',
      WORKER_URL: 'wss://invalid.test',
    });
  ...
  it('handles URLs with international domain names', async () => {
    const result = await runScript(['https://münchen.de'], {
      CDP_SECRET: 'test-secret',
      WORKER_URL: 'wss://invalid.test',
    });
  ...
  it('handles empty CDP_SECRET gracefully', async () => {
    const result = await runScript(['https://example.com'], {
      CDP_SECRET: '',
      WORKER_URL: 'https://test.com',
    });
  ...
  it('handles output path with nested directories', async () => {
    const result = await runScript(['https://example.com', '/tmp/nested/path/screenshot.png'], {
      CDP_SECRET: 'test-secret',
      WORKER_URL: 'wss://invalid.test',
    });
  ...
  it('handles URL with @ symbol in path', async () => {
    const result = await runScript(['https://example.com/@username/profile'], {
      CDP_SECRET: 'test-secret',
      WORKER_URL: 'wss://invalid.test',
    });
  ...
  it('handles very short URLs', async () => {
    const result = await runScript(['https://a.b'], {
      CDP_SECRET: 'test-secret',
      WORKER_URL: 'wss://invalid.test',
    });
